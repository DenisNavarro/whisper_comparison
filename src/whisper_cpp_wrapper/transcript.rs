//! Code adapted from <https://github.com/m1guelpf/whisper-cli-rs/blob/v0.1.4/src/transcript.rs>

use serde::{Deserialize, Serialize};
use std::time::Duration;

use crate::whisper_cpp_wrapper::utils::format_timestamp;
...
impl Transcript {
    ...
    pub fn as_vtt(&self) -> String {
        self.word_utterances.as_ref().unwrap_or(&self.utterances).iter().fold(
            String::new(),
            |transcript, fragment| {
                transcript
                    + format!(
