...
impl Whisper {
    pub fn new(model: &Model, lang: Option<Language>) -> Self {
        Self {
            lang,
    ...
    pub fn transcribe(
        ...
        for s in 0..num_segments {
            ...
            utterances.push(Utternace { start, stop, text });
            ...
            for t in 0..num_tokens {
                ...
                words.push(Utternace { text, start: token_data.t0, stop: token_data.t1 });
            }
        }
